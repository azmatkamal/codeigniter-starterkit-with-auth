...
class My_Controller extends CI_Controller
{
    ...
    public function reset_password_email($to, $reset_code, $subject=null, $body=null) {
        $reset_link = base_url() . 'reset-password/verify?token=' . $reset_code;
        send_mail(
            $to,
            $subject ?? 'Reset Password :: All Care Portal',
            $body ?? 'Here is a link to reset your password.<br/><br/>
