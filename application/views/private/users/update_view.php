<div class="row">
    <div class="col-md-6">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form" action="<?php echo base_url(); ?>users/update" method="post">
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username" value="<?php echo $user->username; ?>" placeholder="username" readonly>
                        <span class="form-text text-danger"><?php echo form_error('username'); ?></span>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="text" class="form-control" name="email" value="<?php echo $user->email; ?>" placeholder="email" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <select name="user_type" id="user_type" class="form-control">
                            ...
                            <?php if(is_employee()): ?>
                                <option value="3" <?php echo $user->user_type=='3' ? 'selected' : ''; ?>>Client</option>
                            <?php endif; ?>
                            <?php if(is_admin()): ?>
                                <option value="2" <?php echo $user->user_type=='2' ? 'selected' : ''; ?>>Employee</option>
                                <option value="1" <?php echo $user->user_type=='1' ? 'selected' : ''; ?>>Administrator</option>
                            <?php endif; ?>
                        </select>
