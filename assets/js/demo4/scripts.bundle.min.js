        ...
        sticky: {
          ...
          position: {
            ...
            left: function () {
              if (KTUtil.isInResponsiveRange("tablet-and-mobile"))
                return parseInt(
                  KTUtil.css(KTUtil.get("kt_body"), "paddingLeft")
                );
            },
            right: function () {
              if (KTUtil.isInResponsiveRange("tablet-and-mobile"))
    ...
    initHeader: function () {
      ...
      (t = KTUtil.get("kt_header")),
        (a = {
          ...
          offset: { dekstop: parseInt(KTUtil.css(t, "height")) + 200 },
          minimize: { desktop: { on: "kt-header--minimize" }, mobile: !1 },
        }),
        new KTHeader("kt_header", a),
    ...
    initAside: function () {
      ...
      (o = KTUtil.get("kt_aside")),
        ...
        KTUtil.hasClass(t, "kt-aside--fixed") &&
          (KTUtil.addEvent(o, "mouseenter", function (n) {
            n.preventDefault(),
          ...
          KTUtil.addEvent(o, "mouseleave", function (n) {
            n.preventDefault(),
              !1 !== KTUtil.isInResponsiveRange("desktop") &&
