...
var KTLayout = (function () {
  ...
  var initAside = function () {
    ...
    if (
      KTUtil.hasClass(body, "kt-aside--fixed") &&
      KTUtil.attr(menu, "data-ktmenu-scroll") == "1"
    ) {
      var insideTm;
      var outsideTm;
      ...
      scroll = {
        ...
        height: function () {
          ...
          if (KTUtil.isInResponsiveRange("desktop")) {
            height =
              parseInt(KTUtil.getViewPort().height) -
              parseInt(KTUtil.actualHeight("kt_header_brand"));
          } else {
      ...
      sticky: {
        ...
        position: {
          top: function () {
            if (KTUtil.isInResponsiveRange("desktop")) {
              ...
              if (
                ...
                h =
                  h +
                  parseInt(KTUtil.css(KTUtil.get("kt_subheader"), "height"));
              }
          ...
          left: function () {
            ...
            left += parseInt(
              KTUtil.css(KTUtil.get("kt_content"), "paddingLeft")
            );
          ...
          right: function () {
            ...
            if (KTUtil.isInResponsiveRange("desktop")) {
              if (KTUtil.hasClass(body, "kt-aside-secondary--enabled")) {
                ...
                right += parseInt(
                  KTUtil.css(KTUtil.get("kt_content"), "paddingRight")
                );
              }
            }
