          ...
          position: {
            top: function () {
              if (KTUtil.isInResponsiveRange("desktop")) {
                var e = parseInt(KTUtil.css(KTUtil.get("kt_header"), "height"));
                return (
                  KTUtil.isInResponsiveRange("desktop") &&
                    KTUtil.hasClass(t, "kt-subheader--fixed") &&
                    KTUtil.get("kt_subheader") &&
                    (e += parseInt(
                      KTUtil.css(KTUtil.get("kt_subheader"), "height")
                    )),
                  e
                );
              }
            ...
            right: function () {
              ...
              return (
                KTUtil.isInResponsiveRange("desktop") &&
                  (KTUtil.hasClass(t, "kt-aside-secondary--enabled")
                    ? KTUtil.hasClass(t, "kt-aside-secondary--expanded")
                      ? (e += 370)
                      : (e += 60)
                    : (e += parseInt(
                        KTUtil.css(KTUtil.get("kt_content"), "paddingRight")
                      ))),
                KTUtil.get("kt_aside_secondary") &&
                  (e += parseInt(
                    KTUtil.css(KTUtil.get("kt_content"), "paddingRight")
                  )),
                e
    ...
    initAside: function () {
      ...
      (s = KTUtil.get("kt_aside")),
        ...
        KTUtil.hasClass(t, "kt-aside--fixed") &&
          "1" == KTUtil.attr(c, "data-ktmenu-scroll") &&
        ...
        (function () {
          var t,
            e = KTUtil.get("kt_aside_menu"),
            a =
              "1" === KTUtil.attr(e, "data-ktmenu-dropdown")
                ? "dropdown"
                : "accordion";
          "1" === KTUtil.attr(e, "data-ktmenu-scroll") &&
            (t = {
              rememberPosition: !0,
              height: function () {
                var t;
                return (
                  (t = KTUtil.isInResponsiveRange("desktop")
                    ...
                    : parseInt(KTUtil.getViewPort().height)),
                  (t -=
                    parseInt(KTUtil.css(e, "marginBottom")) +
                    parseInt(KTUtil.css(e, "marginTop")))
                );
              },
            }),
            (n = new KTMenu("kt_aside_menu", {
              scroll: t,
              submenu: { desktop: a, tablet: "accordion", mobile: "accordion" },
