...
var KTLayout = (function () {
          ...
          position: {
            top: function () {
              if (KTUtil.isInResponsiveRange("desktop")) {
                ...
                return (
                  KTUtil.isInResponsiveRange("desktop") &&
                    KTUtil.hasClass(t, "kt-content-head--fixed") &&
                    KTUtil.get("kt_content_head") &&
                    (e += parseInt(
                      KTUtil.css(KTUtil.get("kt_content_head"), "height")
                    )),
                  e
                );
              }
  ...
  return {
    ...
    initAside: function () {
      var a, r;
      (a = KTUtil.get("kt_aside")),
        KTUtil.get("kt_aside_brand"),
        (r = KTUtil.hasClass(a, "kt-aside--offcanvas-default")
          ...
          if (
            ...
            for (
              ...
              KTUtil.scrollInit(r, {
                ...
                n.on("submenuToggle", function (t, e) {
                  e && r && r.contains(e) && KTUtil.scrollUpdate(r);
                });
            }
        })(),
