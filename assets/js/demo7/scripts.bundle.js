...
var KTLayout = (function () {
  ...
  var initAsideMenu = function () {
    ...
    if (KTUtil.isInResponsiveRange("desktop")) {
      var query = KTUtil.findAll(
        aside,
        ".kt-menu__item--submenu-fullheight .kt-menu__submenu > .kt-menu__wrapper"
      );
        ...
        position: {
          top: function () {
            if (KTUtil.isInResponsiveRange("desktop")) {
              ...
              if (
                KTUtil.isInResponsiveRange("desktop") &&
                KTUtil.hasClass(body, "kt-content-head--fixed") &&
                KTUtil.get("kt_content_head")
              ) {
                h =
                  h +
                  parseInt(KTUtil.css(KTUtil.get("kt_content_head"), "height"));
              }
          ...
          left: function () {
            ...
            left += parseInt(
              KTUtil.css(KTUtil.get("kt_content_body"), "paddingLeft")
            );
          ...
          right: function () {
            ...
            if (KTUtil.isInResponsiveRange("desktop")) {
              if (KTUtil.hasClass(body, "kt-aside-secondary--enabled")) {
                ...
                right += parseInt(
                  KTUtil.css(KTUtil.get("kt_content_body"), "paddingRight")
                );
              }
            }
