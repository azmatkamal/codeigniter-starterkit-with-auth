  ...
  return {
    ...
    on: function (t, e, a, n) {
      if (e) {
        ...
        return (
          (KTUtilDelegatedEventHandlers[i] = function (a) {
          ...
          KTUtil.addEvent(t, a, KTUtilDelegatedEventHandlers[i]),
          i
        );
      }
    },
          ...
          construct: function (t) {
            return (
              KTUtil.data(n).has("avatar")
                ...
                : (o.init(t), o.build(), KTUtil.data(n).set("avatar", a)),
              a
            );
          },
          init: function (t) {
              ...
              window.addEventListener("scroll", function () {
                ...
                KTUtil.isInResponsiveRange("desktop")
                  ? ((s = a.options.offset.desktop),
                    ...
                    (o = a.options.minimize.desktop.off))
                  : KTUtil.isInResponsiveRange("tablet-and-mobile") &&
                    ((s = a.options.offset.mobile),
                    (n = a.options.minimize.mobile.on),
                    (o = a.options.minimize.mobile.off)),
          ...
          eventTrigger: function (t, e) {
            for (var n = 0; n < a.events.length; n++) {
              ...
              i.name == t &&
                (1 == i.one
                  ? 0 == i.fired &&
                    ((a.events[n].fired = !0), i.handler.call(this, a, e))
          ...
          getSubmenuMode: function (t) {
            return KTUtil.isInResponsiveRange("desktop")
              ? t &&
                ...
                ? KTUtil.hasClasses(o, a.options.submenu.desktop.state.body)
              ...
              if (
                ...
                if (!1 === KTUtil.hasClass(o, "kt-menu__item--open")) {
                  ...
                  KTUtil.slideUp(l, s, function () {
                    r.scrollToItem(i), r.eventTrigger("submenuToggle", l);
                  }),
          ...
          resetActiveItem: function (t) {
            for (
              var e,
                n,
                o = 0,
                l = (e = i.querySelectorAll(".kt-menu__item--active")).length;
              o < l;
              o++
            ) {
              var r = e[0];
...
var KTOffcanvas = function (t, e) {
        ...
        l = {
          ...
          onScrollSticky: function (t) {
            ...
            if (!isNaN(e)) {
              ...
              o >= e && !1 === KTUtil.hasClass(i, "kt-portlet--sticky")
            ...
            if (
              ...
              if (
                ...
                KTUtil.css(a.body, "margin-bottom", e + "px"),
                  KTUtil.css(a.foot, "margin-top", "-" + o + "px");
              }
          ...
          construct: function (t) {
            return (
              KTUtil.data(n).has("toggle")
                ...
                : (o.init(t), o.build(), KTUtil.data(n).set("toggle", a)),
              a
            );
          },
          init: function (t) {
  ...
  KTWizard = function (t, e) {
    ...
    KTUtil.get("body");
    if (n) {
      var i = { startStep: 1, manualStepForward: !1 },
        o = {
          construct: function (t) {
            return (
              KTUtil.data(n).has("wizard")
                ? (a = KTUtil.data(n).get("wizard"))
                : (o.init(t), o.build(), KTUtil.data(n).set("wizard", a)),
              a
            );
          },
          init: function (t) {
          ...
          goTo: function (t) {
            if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
              ...
              if (
                ((e =
                  (t = t ? parseInt(t) : o.getNextStep()) > a.currentStep
          ...
          updateUI: function () {
            ...
            if (n && n.length > 0)
              for (var i = 0, l = n.length; i < l; i++)
                i == e
                  ? KTUtil.attr(n[i], "data-ktwizard-state", "current")
                  : i < e
                  ? KTUtil.attr(n[i], "data-ktwizard-state", "done")
                  : KTUtil.attr(n[i], "data-ktwizard-state", "pending");
            ...
            if (r && r.length > 0)
              for (i = 0, l = r.length; i < l; i++)
                i == e
                  ? KTUtil.attr(r[i], "data-ktwizard-state", "current")
                  : KTUtil.removeAttr(r[i], "data-ktwizard-state");
            ...
            if (s && s.length > 0)
              for (i = 0, l = s.length; i < l; i++)
                i == e
                  ? KTUtil.attr(s[i], "data-ktwizard-state", "current")
                  : KTUtil.removeAttr(s[i], "data-ktwizard-state");
          },
      ...
      var l = {
        ...
        init: function (e) {
          ...
          null === e.data.source && (l.extractTable(), (n = !0)),
            ...
            t(o).on("kt-datatable--on-layout-updated", l.afterRender),
          ...
          l.setupSubDatatable.call(),
            ...
            l.isLocked() ||
              ...
              l.isSubtable() ||
                ...
                l.autoHide(),
              t(o.table).find(".kt-datatable__row").css("height", "")),
            l.rowEvenOdd.call(),
            l.sorting.call(),
            l.scrollbar.call(),
            l.isInit ||
                              ...
                              t(this)
                                ...
                                .each(function () {
                                  ...
                                  void 0 !== n
                                    ? ((void 0 === n.left && !0 !== n) ||
                                        t(this).appendTo(e),
                                      void 0 !== n.right && t(this).appendTo(o))
                                    : t(this).appendTo(a);
                                }),
                                t(this).remove();
                            }),
                            e.lockEnabled.left.length > 0 &&
                              (t(o.wrap).addClass("kt-datatable--lock"),
                              t(n).appendTo(a)),
                            (e.lockEnabled.left.length > 0 ||
        ...
        fullRender: function () {
          t(o.tableHead).empty(),
            ...
            l.getOption("layout.footer") &&
              (t(o.tableFoot).empty(), l.setHeadTitle(o.tableFoot)),
            l.spinnerCallback(!0),
        ...
        adjustLockContainer: function () {
          ...
          return (
            t(o.table).find(".kt-datatable__lock--scroll").css("width", i), i
          );
        },
        dragResize: function () {
          var e,
          ...
          t(o.tableHead)
            ...
            .mousedown(function (o) {
              (i = t(this)),
                ...
                (e = o.pageX),
                (a = t(this).width()),
                t(i).addClass("kt-datatable__cell--resizing");
            })
          ...
          (o.initialDatatable = t(o).clone()),
            "TABLE" === t(o).prop("tagName")
              ? ((o.table = t(o)
                ...
                0 === t(o.table).parents(".kt-datatable").length &&
                  (o.table.wrap(
                    t("<div/>")
                      .addClass("kt-datatable")
                      .addClass("kt-datatable--" + i.layout.theme)
                  ),
            ...
            void 0 === t(o).attr("id") &&
              ...
              t(o.table).attr("id", a.getUniqueID("kt-datatable--"))),
            l.getOption("layout.minHeight") &&
              t(o.table).css("min-height", l.getOption("layout.minHeight")),
            l.getOption("layout.height") &&
              t(o.table).css("max-height", l.getOption("layout.height")),
            null === i.data.type &&
              t(o.table).css("width", "").css("display", ""),
            (o.tableHead = t(o.table).find("thead")),
            0 === t(o.tableHead).length &&
              (o.tableHead = t("<thead/>").prependTo(o.table)),
            ...
            void 0 !== i.layout.footer &&
              ...
              0 === t(o.tableFoot).length &&
                (o.tableFoot = t("<tfoot/>").appendTo(o.table)));
        },
                    ...
                    .each(function (n, r) {
                      ...
                      if (void 0 !== s && void 0 !== s.template) {
                        ...
                        "string" == typeof s.template &&
                          (d = l.dataPlaceholder(s.template, i)),
          ...
          if (((o.dataSet = o.dataSet || []), 0 !== o.dataSet.length)) {
            ...
            var a = function (a) {
              ...
              if (void 0 !== n && void 0 !== n.selector && !1 !== n.selector) {
                ...
                if (t(i).find('.kt-checkbox [type="checkbox"]').length > 0)
                  return;
            ...
            i.layout.header &&
              a(t(o.tableHead).find(".kt-datatable__row").first()),
              i.layout.footer &&
                a(t(o.tableFoot).find(".kt-datatable__row").first());
          }
        },
        maxWidthList: {},
                  ...
                  if (void 0 !== r)
                    if ("auto" === r) {
                      ...
                      if (l.maxWidthList[s]) i = l.maxWidthList[s];
                        ...
                        i = l.maxWidthList[s] = Math.max.apply(
                          null,
                          t(d)
                            .map(function () {
            ...
            init: function () {
              ...
              if (i.layout.scroll) {
                ...
                t(r).find(".kt-datatable__row").length > 0 && t(r).length > 0
                  ...
                  : t(o.tableBody).find(".kt-datatable__row").length > 0 &&
                    ((e.scrollHead = t(o.tableHead).find(
                      "> .kt-datatable__row"
                    )),
                    (e.scrollFoot = t(o.tableFoot).find(
                    ...
                    10 != a.detectIE() &&
                    n > a.getBreakpoint("lg")
                      ? e.initCustomScrollbar(o.tableBody)
                      : e.initDefaultScrollbar(o.tableBody));
              }
            },
        ...
        initScrollbar: function (e, n) {
          if (e && e.nodeName)
            if ((t(o.tableBody).css("overflow", ""), a.hasClass(e, "ps")))
              t(e).data("ps").update();
            else {
        ...
        setHeadTitle: function (e) {
          ...
          void 0 === r &&
            ...
            t.each(n, function (e, n) {
              ...
              if (
                (void 0 === i &&
                  ((i = document.createElement("th")), r.appendChild(i)),
                void 0 !== n.title &&
                  ((i.innerHTML = n.title),
                  ...
                  void 0 !== n.autoHide &&
                    (!0 !== n.autoHide
                      ? i.setAttribute("data-autohide-disabled", n.autoHide)
                      : i.setAttribute("data-autohide-enabled", n.autoHide)),
                  t(i).data(n)),
                void 0 !== n.attr &&
        ...
        insertData: function () {
          ...
          if (
            (t.each(o.dataSet, function (n, r) {
              ...
              for (var p = 0; p < u; p += 1) {
                ...
                a.addClass(m, g.join(" ")),
                  ...
                  void 0 !== f.autoHide &&
                    (!0 !== f.autoHide
                      ? m.setAttribute("data-autohide-disabled", f.autoHide)
                      : m.setAttribute("data-autohide-enabled", f.autoHide)),
            ...
            a.addClass(p, "kt-datatable--error"),
              ...
              c.appendChild(p),
              t(o.wrap).addClass("kt-datatable--error kt-datatable--loaded"),
              l.spinnerCallback(!1);
          }
          ...
          return t
            ...
            .done(function (e, a, n) {
              (o.lastResponse = e),
                ...
                l.setAutoColumns(),
                t(o).trigger("kt-datatable--on-ajax-done", [o.dataSet]);
            })
            .fail(function (e, a, n) {
          ...
          var i = {
            ...
            init: function (e) {
              (i.meta = e),
                ...
                (i.pager = t(o.table).siblings(".kt-datatable__pager")),
                t(i.pager).hasClass("kt-datatable--paging-loaded") ||
                  (t(i.pager).remove(),
                  0 !== i.meta.pages &&
            ...
            openPage: function (e) {
              (i.meta.page = parseInt(e)),
                t(o).trigger(i.paginateEvent, i.meta),
                i.callback(i, i.meta),
                t(i.pager).trigger("kt-datatable--on-goto-page", i.meta);
            },
            updatePerpage: function (e) {
              e.preventDefault(),
                ...
                t(i.pager).trigger("kt-datatable--on-update-perpage", i.meta),
                t(o).trigger(i.paginateEvent, i.meta),
                i.callback(i, i.meta),
                i.updateInfo.call();
            },
              ...
              t(o)
                ...
                .on(i.paginateEvent, function (e, a) {
                  ...
                  t(n)
                    ...
                    t(i.pager).find(".kt-datatable__pager-nav").show(),
                    a.pages <= 1 &&
                      t(i.pager).find(".kt-datatable__pager-nav").hide(),
                    l.setDataSourceParam("pagination", {
                      page: i.meta.page,
                      pages: i.meta.pages,
                      perpage: i.meta.perpage,
                ...
                .html(
                  l.dataPlaceholder(
                    l.getOption("translate.toolbar.pagination.items.info"),
                    {
                      ...
                      pageSize:
                        -1 === i.meta.perpage || i.meta.perpage >= i.meta.total
                          ? i.meta.total
                          : i.meta.perpage,
                      total: i.meta.total,
                    }
            ...
            paginationUpdate: function () {
              ...
              t(n).each(function (e, a) {
                ...
                f === i.meta.pages && f === t(u).last().data("page")
                  ? t(n).parent().hide()
                  : t(n).parent().show(),
                1 === i.meta.page
                  ? (t(r)
        ...
        columnHide: function () {
          ...
          t.each(i.columns, function (n, i) {
            if (void 0 !== i.responsive) {
              ...
              a.getBreakpoint(i.responsive.hidden) >= e
                ? t(r).hide()
                : t(r).show(),
                a.getBreakpoint(i.responsive.visible) <= e
                  ? t(r).show()
                  : t(r).hide();
            }
          });
        ...
        setupSubDatatable: function () {
          ...
          if (
            "function" == typeof e &&
            !(t(o.table).find(".kt-datatable__subtable").length > 0)
          ) {
            ...
            var a = function (a) {
                ...
                t(n).hasClass("kt-datatable__row--subtable-expanded")
                  ? (t(c).addClass(
                    ...
                    t(o).trigger("kt-datatable--on-collapse-subtable", [n]))
                  : (t(c).addClass(
                      l.getOption("layout.icons.rowDetail.expand")
                    ),
                    t(n).addClass("kt-datatable__row--subtable-expanded"),
                    t(o).trigger("kt-datatable--on-expand-subtable", [n])),
                  ...
                  .each(function (e, i) {
                    ...
                    if (void 0 !== o) {
                      ...
                      if (void 0 !== o.subtable && o.subtable) {
                        if (
                          t(i).find(".kt-datatable__toggle-subtable").length > 0
                        )
                          return;
                        t(i).html(
                          t("<a/>")
                ...
                t(o.tableBody)
                  ...
                  .each(function () {
                    0 === t(this).find(".kt-datatable__toggle-detail").length &&
                      ...
                      0 ===
                      t(o.tableHead).find(".kt-datatable__toggle-detail").length
                        ? (t(o.tableHead)
                            .find(".kt-datatable__row")
                            .first()
                            .prepend(
            ...
            (t.each(o.dataSet[0], function (e, a) {
              0 ===
                t.grep(i.columns, function (t, a) {
                  return e === t.field;
                }).length && i.columns.push({ field: e, title: e });
            }),
            t(o.tableHead).find(".kt-datatable__row").remove(),
            l.setHeadTitle(),
            l.getOption("layout.footer") &&
              (t(o.tableFoot).find(".kt-datatable__row").remove(),
          ...
          var e = {
            ...
            sortClick: function (n) {
              ...
              if (
                ...
                t(o.tableHead).find(".kt-datatable__cell > span > i").remove(),
                i.sortable)
              ) {
                l.spinnerCallback(!0);
                var c = "desc";
                l.getObject("field", r) === s && (c = l.getObject("sort", r)),
                  ...
                  setTimeout(function () {
                    l.dataRender("sort"),
                      t(o).trigger("kt-datatable--on-sort", r);
                  }, 300);
              }
            },
          };
        ...
        localDataUpdate: function () {
          ...
          if (
            (void 0 !== i && !0 !== l.getOption("data.serverSorting")
              ? "function" == typeof i.sortCallback
                ? (o.dataSet = i.sortCallback(o.originalDataSet, n, i))
                : (o.dataSet = l.sortCallback(o.originalDataSet, n, i))
              : (o.dataSet = o.originalDataSet),
        ...
        resetScroll: function () {
          void 0 === i.detail &&
            1 === l.getDepth() &&
            (t(o.table).find(".kt-datatable__row").css("left", 0),
            t(o.table).find(".kt-datatable__lock").css("top", 0),
            ...
            t(o.tableBody)
              ...
              .each(function (a, n) {
                if (e == t(n).text()) {
                  ...
                  return (
                    (o.API.record = o.API.value = l.getOneRow(o.tableBody, i)),
                    o
                  );
                }
              }),
        ...
        setSelectedRecords: function () {
          return (
            (o.API.record = t(o.tableBody).find(".kt-datatable__row--active")),
            o
          );
        },
        getSelectedRecords: function () {
          return (
            l.setSelectedRecords(),
            (o.API.record = o.rows(".kt-datatable__row--active").nodes()),
            o.API.record
          );
        },
        ...
        search: function (e, a) {
          void 0 !== a && (a = t.makeArray(a)),
            ...
            (o = l.getOption("search.delay")),
            clearTimeout(l.timer),
            (l.timer = setTimeout(n, o));
          var n, o;
        },
        ...
        rows: function (e) {
          return (
            l.isLocked()
              ...
              : (l.nodeTr = l.recentNode =
                  t(o.tableBody).find(e).filter(".kt-datatable__row")),
            o
          );
        },
        column: function (e) {
              ...
              if (l.isLocked()) {
                ...
                o
                  ...
                  : t(l.recentNode).closest(".kt-datatable__lock--right")
                      .length && (n += a.left.length + o + 1);
              }
            }
            e
              ? (l.recentNode === l.nodeCols && delete i.columns[n].responsive,
                t(l.recentNode).show())
        ...
        var n = {
          ...
          init: function () {
            n.selectorEnabled() &&
              ...
              t(e).on("kt-datatable--on-layout-updated", function (a, i) {
                ...
                .click(function (i) {
                  ...
                  t(this).is(":checked")
                    ? (n.selectedRows.push(o),
                      (n.unselectedRows = n.remove(n.unselectedRows, o)))
    ...
    if (e) {
      ...
      var a = function () {
        ...
        if (0 !== n.value.length) {
          ...
          KTUtil.addClass(i, "kt-chat__message kt-chat__message--right");
          var o,
            l =
...
var KTQuickSearch = function () {
    var t,
      ...
      v = function () {
        if (d && s === a.value)
          return g(), KTUtil.addClass(t, f), h(), void KTUtil.scrollUpdate(i);
        (s = a.value),
...
var KTLayout = (function () {
  ...
  return {
    ...
    initHeader: function () {
      var t, i, o;
      (t = KTUtil.get("kt_header")),
        (i = KTUtil.get("kt_header_mobile")),
        (o = {
          classic: { desktop: !0, mobile: !0 },
          offset: {
            desktop: parseInt(KTUtil.css(t, "height")) - 10,
            mobile: parseInt(KTUtil.css(i, "height")) - 10,
          },
          minimize: {
            desktop: { on: "kt-header--minimize" },
            mobile: { on: "kt-header-mobile--scroll" },
          },
        }),
        (e = new KTHeader("kt_header", o)),
        n &&
          (e.on("minimizeOn", function () {
            n.scrollReInit();
          }),
          e.on("minimizeOff", function () {
            n.scrollReInit();
          })),
    ...
    initAside: function () {
      var e, a, o, l, r, s, d;
      (o = KTUtil.get("kt_aside")),
        KTUtil.get("kt_aside_brand"),
        (l = KTUtil.hasClass(o, "kt-aside--offcanvas-default")
        ...
        KTUtil.hasClass(t, "kt-aside--fixed") &&
          (KTUtil.addEvent(o, "mouseenter", function (i) {
            i.preventDefault(),
              !1 !== KTUtil.isInResponsiveRange("desktop") &&
                ...
                (e = setTimeout(function () {
                  KTUtil.hasClass(t, "kt-aside--minimize") &&
                    KTUtil.isInResponsiveRange("desktop") &&
                    (KTUtil.removeClass(t, "kt-aside--minimize"),
                    KTUtil.addClass(t, "kt-aside--minimizing"),
                    KTUtil.transitionEnd(t, function () {
                      KTUtil.removeClass(t, "kt-aside--minimizing");
                    }),
                    KTUtil.addClass(t, "kt-aside--minimize-hover"),
                    n.scrollUpdate(),
                    n.scrollTop());
                }, 50)));
          }),
          KTUtil.addEvent(o, "mouseleave", function (i) {
            i.preventDefault(),
              !1 !== KTUtil.isInResponsiveRange("desktop") &&
                (e && (clearTimeout(e), (e = null)),
                (a = setTimeout(function () {
                  KTUtil.hasClass(t, "kt-aside--minimize-hover") &&
                    KTUtil.isInResponsiveRange("desktop") &&
                    (KTUtil.removeClass(t, "kt-aside--minimize-hover"),
                    KTUtil.addClass(t, "kt-aside--minimize"),
                    KTUtil.addClass(t, "kt-aside--minimizing"),
                    KTUtil.transitionEnd(t, function () {
                      KTUtil.removeClass(t, "kt-aside--minimizing");
                    }),
        ...
        (s = KTUtil.get("kt_aside_menu")),
        (d =
          "1" === KTUtil.attr(s, "data-ktmenu-dropdown")
            ? "dropdown"
            : "accordion"),
        "1" === KTUtil.attr(s, "data-ktmenu-scroll") &&
          (r = {
            rememberPosition: !0,
            height: function () {
              return KTUtil.isInResponsiveRange("desktop")
                ? parseInt(KTUtil.getViewPort().height) -
                    parseInt(KTUtil.actualHeight("kt_header", !1)) -
                    parseInt(KTUtil.actualHeight("kt_footer", !1)) -
                    parseInt(KTUtil.css(s, "marginTop")) -
                    parseInt(KTUtil.css(s, "marginBottom"))
                : parseInt(KTUtil.getViewPort().height);
            },
          }),
        (n = new KTMenu("kt_aside_menu", {
          scroll: r,
          submenu: { desktop: d, tablet: "accordion", mobile: "accordion" },
    ...
    getContentHeight: function () {
      return (function () {
        ...
        var e = KTUtil.getByID("kt_header"),
          a = KTUtil.find(e, ".kt-header__bottom");
        return (
          e &&
            a &&
            (t =
              (t -= KTUtil.actualHeight(a, "margin-top")) -
              parseInt(KTUtil.css(a, "margin-top")) -
              parseInt(KTUtil.css(a, "margin-bottom"))),
