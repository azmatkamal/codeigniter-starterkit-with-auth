  ...
  return {
    ...
    block: function (target, options) {
      ...
      if (options.message && options.message.length > 0) {
        ...
        el.innerHTML =
          "<span>" + options.message + "</span><span>" + spinner + "</span>";
      ...
      if (el.classList) {
        ...
        for (var i = 0; i < classNames.length; i++) {
          el.className = el.className.replace(
            new RegExp("\\b" + KTUtil.trim(classNames[i]) + "\\b", "g"),
            ""
          );
        }
      }
      ...
      function init() {
        ...
        if ((ps = KTUtil.data(element).get("ps"))) {
          ...
          ps = new PerfectScrollbar(element, {
            ...
            suppressScrollX:
              KTUtil.attr(element, "data-scroll-x") != "true" ? true : false,
          });
  ...
  var Plugin = {
    ...
    getBreadcrumbs: function (item) {
      ...
      for (var i = 0, len = parents.length; i < len; i++) {
        ...
        breadcrumbs.push({
          text: (query = KTUtil.child(submenuLink, ".kt-menu__link-text")
            ? query.innerHTML
            : ""),
...
(function ($) {
  ...
  $.fn[pluginName] = function (options) {
    ...
    var Plugin = {
                ...
                if (dataWidth === "auto") {
                  ...
                  if (Plugin.maxWidthList[field]) {
                    ...
                    var cells = $(datatable.table).find(
                      "." + pfx + 'datatable__cell[data-field="' + field + '"]'
                    );
          ...
          var ps = new PerfectScrollbar(
            ...
            Object.assign(
              {},
              {
                ...
                maxScrollbarLength: 300,
                suppressScrollX:
                  Plugin.getOption("rows.autoHide") && !Plugin.isLocked(),
              },
              options
            )
          );
        ...
        var pg = {
          ...
          populate: function () {
            ...
            pg.pager = $("<div/>").addClass(
              pfx + "datatable__pager " + pfx + "datatable--paging-loaded"
            );
            // numbering links
          ...
          if (hiddenExist) {
            ...
            $(datatable.tableBody)
              ...
              .each(function () {
                // if no toggle yet
                if (
                  $(this).find("." + pfx + "datatable__toggle-detail")
                    .length === 0
                ) {
                  // add toggle
                  $(this).prepend(
      ...
      isSubtable: function () {
        return (
          util.hasClass(datatable.wrap[0], pfx + "datatable--subtable") || false
        );
      },
      ...
      height: function () {
        ...
        if (KTUtil.isInResponsiveRange("tablet-and-mobile")) {
          return KTUtil.hasAttr(messageListEl, "data-mobile-height")
            ? parseInt(KTUtil.attr(messageListEl, "data-mobile-height"))
            : 300;
        }
    ...
    var handleMessaging = function () {
      ...
      setTimeout(function () {
        ...
        var html =
          '<div class="kt-chat__user">' +
          '<span class="kt-userpic kt-userpic--circle kt-userpic--sm">' +
          '<img src="<?php echo base_url(); ?>assets/media/users/100_13.jpg" alt="image">' +
          "</span>" +
  ...
  var initNotifications = function () {
    ...
    KTUtil.scrollInit(body, {
      ...
      height: function () {
        ...
        height =
          height - parseInt(KTUtil.css(notificationPanel, "paddingBottom"));
  ...
  var initQucikActions = function () {
    ...
    KTUtil.scrollInit(body, {
      ...
      height: function () {
        ...
        height =
          height - parseInt(KTUtil.css(quickActionsPanel, "paddingBottom"));
...
var KTLayout = (function () {
      ...
      scroll = {
        ...
        height: function () {
          ...
          if (KTUtil.isInResponsiveRange("desktop")) {
            height =
              parseInt(KTUtil.getViewPort().height) -
              parseInt(KTUtil.actualHeight("kt_header", false)) -
              parseInt(KTUtil.actualHeight("kt_footer", false));
            height =
              height -
        ...
        position: {
          top: function () {
            if (KTUtil.isInResponsiveRange("desktop")) {
              ...
              return parseInt(
                KTUtil.css(KTUtil.get("kt_header_mobile"), "height")
              );
            }
          },
          left: function () {
            if (KTUtil.isInResponsiveRange("tablet-and-mobile")) {
              return parseInt(
                KTUtil.css(KTUtil.get("kt_content_wrapper"), "paddingLeft")
              );
            }
          ...
          right: function () {
            if (KTUtil.isInResponsiveRange("tablet-and-mobile")) {
              return parseInt(
                KTUtil.css(KTUtil.get("kt_content_wrapper"), "paddingRight")
              );
            }
  ...
  var getContentHeight = function () {
    ...
    if (headerEl && headerBottomEl) {
      ...
      height =
        height -
        parseInt(KTUtil.css(headerBottomEl, "margin-top")) -
        parseInt(KTUtil.css(headerBottomEl, "margin-bottom"));
    }
    ...
    if (KTUtil.getByID("kt_wrapper")) {
      height =
        height -
        parseInt(KTUtil.css("kt_wrapper", "padding-top")) -
        parseInt(KTUtil.css("kt_wrapper", "padding-bottom"));
    }

    if (KTUtil.getByID("kt_body")) {
      height =
        height -
        parseInt(KTUtil.css("kt_body", "padding-top")) -
        parseInt(KTUtil.css("kt_body", "padding-bottom"));
    }
      ...
      $("#kt_aside_menu, #kt_header_menu").on(
        ...
        function () {
          if (location.hostname.match("keenthemes.com")) {
            swal.fire(
              "You have clicked on a dummy link!",
              "To browse the theme features please refer to the header menu.",
              "warning"
            );
          } else {
            swal.fire(
              "You have clicked on a dummy link!",
              "This demo shows only its unique layout features. <b>Keen's</b> all available features can be re-used in this and any other demos by refering to <b>the default demo</b>.",
              "warning"
            );
          }
        }
