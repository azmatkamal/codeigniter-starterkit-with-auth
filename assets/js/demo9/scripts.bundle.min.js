    ...
    l = function () {
      $('[data-ktportlet="true"]').each(function () {
        ...
        !0 !== t.data("data-ktportlet-initialized") &&
          (i(t, {}), t.data("data-ktportlet-initialized", !0));
      });
    },
    r = function () {
  ...
  return {
    ...
    initComponents: function () {
      $('[data-scroll="true"]').each(function () {
        ...
        KTUtil.scrollInit(this, {
          ...
          height: function () {
            return KTUtil.isInResponsiveRange("tablet-and-mobile") &&
    ...
    initAbsoluteDropdown: function (t) {
      !(function (t) {
        var e;
        t &&
          (t.on("show.bs.dropdown", function (t) {
    ...
    block: function (t, e) {
      ...
      var l = {
        ...
        onUnblock: function () {
          n &&
            n[0] &&
            (KTUtil.css(n[0], "position", ""), KTUtil.css(n[0], "zoom", ""));
        },
      };
  ...
  return {
      ...
      for (var e, a, n = KTUtil.get(t); n && n !== document; ) {
        if (
          ("absolute" === (e = KTUtil.css(n, "position")) ||
            "relative" === e ||
            "fixed" === e) &&
          ((a = parseInt(KTUtil.css(n, "z-index"))), !isNaN(a) && 0 !== a)
        )
          return a;
        n = n.parentNode;
      }
        ...
        if (t.classList)
          ...
          for (n = 0; n < a.length; n++)
            t.className = t.className.replace(
              new RegExp("\\b" + KTUtil.trim(a[n]) + "\\b", "g"),
              ""
            );
      }
    },
    ...
    triggerEvent: function (t, e) {
      ...
      if (t.dispatchEvent) {
        ...
        switch (e) {
          ...
          default:
            throw (
              "fireEvent: Couldn't find an event class for event '" + e + "'."
            );
        }
        var o = "change" != e;
        (i = a.createEvent(n)).initEvent(e, o, !0),
          (i.synthetic = !0),
          t.dispatchEvent(i, !0);
      } else if (t.fireEvent) {
        var i;
      ...
      if (t && t.childNodes) {
        for (var n = [], o = 0, i = t.childNodes.length; o < i; ++o)
          1 == t.childNodes[o].nodeType &&
            KTUtil.matches(t.childNodes[o], e, a) &&
      ...
      return (
        (t = KTUtil.get(t)),
        {
          set: function (e, a) {
            void 0 !== t &&
              (void 0 === t.customDataTag &&
                ...
                (t.customDataTag = KTUtilElementDataStoreID)),
              void 0 === KTUtilElementDataStore[t.customDataTag] &&
                (KTUtilElementDataStore[t.customDataTag] = {}),
              (KTUtilElementDataStore[t.customDataTag][e] = a));
          },
          get: function (e) {
            if (void 0 !== t)
              return void 0 === t.customDataTag
                ? null
                : this.has(e)
                ? KTUtilElementDataStore[t.customDataTag][e]
                : null;
          },
          has: function (e) {
            return (
          ...
          remove: function (e) {
            t &&
              this.has(e) &&
              delete KTUtilElementDataStore[t.customDataTag][e];
          },
        }
      );
    },
    ...
    slide: function (t, e, a, n, o) {
      if (
        ...
        KTUtil.css(t, "padding-top") &&
          ...
          KTUtil.data(t).set("slide-padding-top", KTUtil.css(t, "padding-top")),
          ...
          KTUtil.data(t).has("slide-padding-bottom") &&
            (r = parseInt(KTUtil.data(t).get("slide-padding-bottom"))),
          "up" == e
    ...
    on: function (t, e, a, n) {
      if (e) {
        ...
        return (
          (KTUtilDelegatedEventHandlers[o] = function (a) {
          ...
          KTUtil.addEvent(t, a, KTUtilDelegatedEventHandlers[o]),
          o
        );
      }
    },
    off: function (t, e, a) {
      t &&
        KTUtilDelegatedEventHandlers[a] &&
        (KTUtil.removeEvent(t, e, KTUtilDelegatedEventHandlers[a]),
        delete KTUtilDelegatedEventHandlers[a]);
    },
    one: function (t, e, a) {
    ...
    scrollTo: function (t, e, a) {
      ...
      var n,
        o,
        i = (t = KTUtil.get(t)) ? KTUtil.offset(t).top : 0,
        l =
          window.pageYOffset ||
      ...
      i > l ? ((n = i), (o = l)) : ((n = l), (o = i)),
        e && (o += e),
        KTUtil.animate(n, o, a, function (t) {
    ...
    scrollInit: function (t, e) {
      function a() {
        ...
        if (
          ...
          (n > 0 && KTUtil.css(t, "height", n + "px"), e.desktopNativeScroll)
        )
          KTUtil.css(t, "overflow", "auto");
        else {
    ...
    scrollDestroy: function (t) {
      var e;
      (e = KTUtil.data(t).get("ps")) &&
        (e.destroy(), (e = KTUtil.data(t).remove("ps")));
    },
          ...
          construct: function (t) {
            return (
              KTUtil.data(n).has("avatar")
                ...
                : (i.init(t), i.build(), KTUtil.data(n).set("avatar", a)),
              a
            );
          },
          init: function (t) {
            ...
            KTUtil.addEvent(a.input, "change", function (t) {
              if (
                ...
                (e.onload = function (t) {
                  ...
                  KTUtil.addClass(a.element, "kt-avatar--changed");
              }
            }),
              KTUtil.addEvent(a.cancel, "click", function (t) {
                t.preventDefault(),
                  KTUtil.removeClass(a.element, "kt-avatar--changed"),
          ...
          eventTrigger: function (t) {
            for (var e = 0; e < a.events.length; e++) {
              ...
              n.name == t &&
                (1 == n.one
                  ? 0 == n.fired &&
                    ((a.events[e].fired = !0), n.handler.call(this, a))
          ...
          construct: function (t) {
            return (
              KTUtil.data(n).has("header")
                ...
                : (l.init(t), l.build(), KTUtil.data(n).set("header", a)),
              a
            );
          },
          init: function (t) {
            ...
            (!1 === a.options.minimize.mobile &&
              ...
              window.addEventListener("scroll", function () {
                ...
                KTUtil.isInResponsiveRange("desktop")
                  ? ((s = a.options.offset.desktop),
                    (n = a.options.minimize.desktop.on),
                    (i = a.options.minimize.desktop.off))
                  : KTUtil.isInResponsiveRange("tablet-and-mobile") &&
                    ((s = a.options.offset.mobile),
                    (n = a.options.minimize.mobile.on),
                    (i = a.options.minimize.mobile.off)),
                  ...
                  (KTUtil.isInResponsiveRange("desktop") &&
                    ...
                    ? r > s
                      ? (KTUtil.addClass(o, n),
                        KTUtil.removeClass(o, i),
                        e && (l.eventTrigger("minimizeOn", a), (e = !1)))
                      : (KTUtil.addClass(o, i),
                        KTUtil.removeClass(o, n),
                        0 == e && (l.eventTrigger("minimizeOff", a), (e = !0)))
                    : (r > s && t < r
                        ? (KTUtil.addClass(o, n),
                          KTUtil.removeClass(o, i),
                          e && (l.eventTrigger("minimizeOn", a), (e = !1)))
                        : (KTUtil.addClass(o, i),
                          KTUtil.removeClass(o, n),
                          0 == e &&
                            (l.eventTrigger("minimizeOff", a), (e = !0))),
                      (t = r));
              });
          },
    ...
    if (o) {
      var l = {
        ...
        r = {
          construct: function (t) {
            return (
              KTUtil.data(o).has("menu")
                ? (a = KTUtil.data(o).get("menu"))
                : (r.init(t),
                  r.reset(),
                  r.build(),
                  KTUtil.data(o).set("menu", a)),
              a
            );
          },
          init: function (t) {
          ...
          reset: function () {
            KTUtil.off(o, "click", a.eventHandlers.event_1),
              KTUtil.off(o, "mouseover", a.eventHandlers.event_2),
              KTUtil.off(o, "mouseout", a.eventHandlers.event_3),
              KTUtil.off(o, "click", a.eventHandlers.event_4),
              KTUtil.off(o, "click", a.eventHandlers.event_5),
          ...
          getSubmenuMode: function (t) {
            return KTUtil.isInResponsiveRange("desktop")
              ? t &&
                ...
                "hover" == KTUtil.attr(t, "data-ktmenu-submenu-toggle")
                ? "dropdown"
                : KTUtil.isset(a.options.submenu, "desktop.state.body")
                ? KTUtil.hasClasses(i, a.options.submenu.desktop.state.body)
          ...
          handleSubmenuDropdownClick: function (t) {
            if ("accordion" !== r.getSubmenuMode(this)) {
              ...
              "accordion" != e.getAttribute("data-ktmenu-submenu-mode") &&
                (!1 === KTUtil.hasClass(e, "kt-menu__item--hover")
                  ? (KTUtil.addClass(e, "kt-menu__item--open-dropdown"),
                    r.showSubmenuDropdown(e))
                  : (KTUtil.removeClass(e, "kt-menu__item--open-dropdown"),
                    r.hideSubmenuDropdown(e, !0)),
                t.preventDefault());
            }
          },
          ...
          handleSubmenuAccordion: function (t, e) {
            ...
            if (
              ...
              (n = o.closest(".kt-menu__item")) &&
              "accordion" != n.getAttribute("data-ktmenu-submenu-mode")
            )
              t.preventDefault();
            else {
                  ...
                  if (!1 === a.options.accordion.expandAll) {
                    ...
                    if (d && c)
                      for (var u = 0, p = c.length; u < p; u++) {
                        ...
                        g &&
                          KTUtil.slideUp(g, s, function () {
                            r.scrollUpdate(),
                              KTUtil.removeClass(f, "kt-menu__item--open");
                          });
                      }
                  }
          ...
          scrollToItem: function (t) {
            KTUtil.isInResponsiveRange("desktop") &&
              ...
              "1" !== o.getAttribute("data-ktmenu-scroll") &&
          ...
          resetActiveItem: function (t) {
            for (
              var e,
                n,
                i = 0,
                l = (e = o.querySelectorAll(".kt-menu__item--active")).length;
              i < l;
              i++
            ) {
              var r = e[0];
              ...
              for (
                var s = 0,
                  d = (n = KTUtil.parents(r, ".kt-menu__item--submenu") || [])
                    .length;
                s < d;
                s++
              ) {
                ...
                KTUtil.removeClass(c, "kt-menu__item--open"),
                  KTUtil.hide(KTUtil.child(c, ".kt-menu__submenu"));
              }
            }
            if (
              !1 === a.options.accordion.expandAll &&
              (e = o.querySelectorAll(".kt-menu__item--open"))
            )
          ...
          setActiveItem: function (t) {
            r.resetActiveItem();
            for (
              var e = KTUtil.parents(t, ".kt-menu__item--submenu") || [],
                a = 0,
                n = e.length;
              a < n;
              a++
            )
              KTUtil.addClass(KTUtil.get(e[a]), "kt-menu__item--open");
          ...
          getBreadcrumbs: function (t) {
            ...
            for (
              var o = KTUtil.parents(t, ".kt-menu__item--submenu"),
                i = 0,
                l = o.length;
              i < l;
              i++
...
var KTOffcanvas = function (t, e) {
        ...
        l = {
          construct: function (t) {
            return (
              KTUtil.data(n).has("offcanvas")
                ...
                : (l.init(t), l.build(), KTUtil.data(n).set("offcanvas", a)),
              a
            );
          },
          init: function (t) {
            (a.events = []),
              ...
              (a.state = KTUtil.hasClass(n, a.classShown) ? "shown" : "hidden");
          },
          build: function () {
          ...
          show: function (t) {
            "shown" != a.state &&
              ...
              KTUtil.addClass(o, a.classShown),
          ...
          hide: function (t) {
            "hidden" != a.state &&
              ...
              KTUtil.removeClass(o, a.classShown),
              KTUtil.removeClass(n, a.classShown),
              (a.state = "hidden"),
              a.options.overlay && a.overlay && KTUtil.remove(a.overlay),
          ...
          togglerClass: function (t, e) {
            ...
            if (
              ...
              for (var i in a.options.toggleBy)
                a.options.toggleBy[i].target === o &&
                  (n = a.options.toggleBy[i]);
            else
              a.options.toggleBy &&
                a.options.toggleBy.target &&
        ...
        l = {
          construct: function (t) {
            return (
              KTUtil.data(n).has("portlet")
                ...
                : (l.init(t), l.build(), KTUtil.data(n).set("portlet", a)),
              a
            );
          },
          init: function (t) {
          ...
          onScrollSticky: function (t) {
            ...
            if (!isNaN(e)) {
              ...
              i >= e && !1 === KTUtil.hasClass(o, "kt-portlet--sticky")
                ? (l.eventTrigger("stickyOn"),
                  KTUtil.addClass(o, "kt-portlet--sticky"),
                  KTUtil.addClass(n, "kt-portlet--sticky"),
                  l.updateSticky())
                : 1.5 * i <= e &&
                  KTUtil.hasClass(o, "kt-portlet--sticky") &&
                  (l.eventTrigger("stickyOff"),
                  KTUtil.removeClass(o, "kt-portlet--sticky"),
          ...
          resetSticky: function () {
            a.head &&
              !1 === KTUtil.hasClass(o, "kt-portlet--sticky") &&
          ...
          remove: function () {
            !1 !== l.eventTrigger("beforeRemove") &&
              (KTUtil.hasClass(o, "kt-portlet--fullscreen") &&
          ...
          removeTooltips: function () {
            if (a.options.tooltips) {
              ...
              var o = KTUtil.find(a.head, "[data-ktportlet-tool=fullscreen]");
              o &&
                KTUtil.data(o).has("tooltip") &&
                KTUtil.data(o).get("tooltip").dispose();
            }
          },
          reload: function () {
          ...
          fullscreen: function (t) {
            if (
              ...
              l.eventTrigger("beforeFullscreenOff"),
                KTUtil.removeClass(o, "kt-portlet--fullscreen"),
              ...
              if (
                ...
                KTUtil.addClass(o, "kt-portlet--fullscreen"),
                l.removeTooltips(),
                l.setupTooltips(),
                a.foot)
              ) {
                ...
                KTUtil.css(a.body, "margin-bottom", e + "px"),
                  KTUtil.css(a.foot, "margin-top", "-" + i + "px");
              }
  ...
  KTScrolltop = function (t, e) {
    var a = this,
      ...
      o = KTUtil.get("body");
    if (n) {
      var i = { offset: 300, speed: 600, toggleClass: "kt-scrolltop--on" },
        l = {
          construct: function (t) {
            return (
              KTUtil.data(n).has("scrolltop")
                ? (a = KTUtil.data(n).get("scrolltop"))
                : (l.init(t), l.build(), KTUtil.data(n).set("scrolltop", a)),
              a
            );
          },
          init: function (t) {
          ...
          handle: function () {
            window.pageYOffset > a.options.offset
              ? KTUtil.addClass(o, a.options.toggleClass)
              : KTUtil.removeClass(o, a.options.toggleClass);
          },
          scroll: function (t) {
    ...
    if (n) {
      var o = { togglerState: "", targetState: "" },
        i = {
          construct: function (t) {
            return (
              KTUtil.data(n).has("toggle")
                ...
                : (i.init(t), i.build(), KTUtil.data(n).set("toggle", a)),
              a
            );
          },
          init: function (t) {
          ...
          toggle: function (t) {
            return (
              i.eventTrigger("beforeToggle"),
              "off" == a.state ? i.toggleOn() : i.toggleOff(),
              i.eventTrigger("afterToggle"),
              t.preventDefault(),
              a
            );
          },
        ...
        i = {
          construct: function (t) {
            return (
              KTUtil.data(n).has("wizard")
                ...
                : (i.init(t), i.build(), KTUtil.data(n).set("wizard", a)),
              a
            );
          },
          init: function (t) {
            (a.element = n),
              (a.events = []),
              (a.options = KTUtil.deepExtend({}, o, t)),
              (a.steps = KTUtil.findAll(n, '[data-ktwizard-type="step"]')),
          ...
          goTo: function (t) {
            if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
              ...
              if (
                ((e =
                  (t = t ? parseInt(t) : i.getNextStep()) > a.currentStep
                    ? i.eventTrigger("beforeNext")
                    : i.eventTrigger("beforePrev")),
                !0 !== a.stopped)
              )
                return (
                  !1 !== e &&
                    (i.eventTrigger("beforeChange"),
                    (a.currentStep = t),
                    i.updateUI(),
                    i.eventTrigger("change")),
                  t > a.startStep
                    ? i.eventTrigger("afterNext")
                    : i.eventTrigger("afterPrev"),
                  a
                );
              a.stopped = !1;
            }
          ...
          updateUI: function () {
            ...
            if (n && n.length > 0)
              for (var o = 0, l = n.length; o < l; o++)
                o == e
                  ? KTUtil.attr(n[o], "data-ktwizard-state", "current")
                  : o < e
                  ? KTUtil.attr(n[o], "data-ktwizard-state", "done")
                  : KTUtil.attr(n[o], "data-ktwizard-state", "pending");
            ...
            if (r && r.length > 0)
              for (o = 0, l = r.length; o < l; o++)
                o == e
                  ? KTUtil.attr(r[o], "data-ktwizard-state", "current")
                  : KTUtil.removeAttr(r[o], "data-ktwizard-state");
            ...
            if (s && s.length > 0)
              for (o = 0, l = s.length; o < l; o++)
                o == e
                  ? KTUtil.attr(s[o], "data-ktwizard-state", "current")
                  : KTUtil.removeAttr(s[o], "data-ktwizard-state");
          },
      ...
      var l = {
        ...
        init: function (e) {
          ...
          null === e.data.source && (l.extractTable(), (n = !0)),
            ...
            ("remote" !== e.data.type && "local" !== e.data.type) ||
              ...
              l.dataRender()),
            n &&
              (t(i.tableHead).find("tr").remove(),
              t(i.tableFoot).find("tr").remove()),
            l.setHeadTitle(),
            l.getOption("layout.footer") && l.setHeadTitle(i.tableFoot),
            void 0 !== e.layout.header &&
              !1 === e.layout.header &&
              t(i.table).find("thead").remove(),
            void 0 !== e.layout.footer &&
              !1 === e.layout.footer &&
              t(i.table).find("tfoot").remove(),
        ...
        layoutUpdate: function () {
          l.setupSubDatatable.call(),
            l.setupSystemColumn.call(),
            l.setupHover.call(),
            void 0 === o.detail && 1 === l.getDepth() && l.lockTable.call(),
            l.columnHide.call(),
            l.resetScroll(),
            l.isLocked() ||
              (l.redraw.call(),
              l.isSubtable() ||
                ...
                l.autoHide(),
              t(i.table).find(".kt-datatable__row").css("height", "")),
            l.rowEvenOdd.call(),
            l.sorting.call(),
            l.scrollbar.call(),
            l.isInit ||
              (l.dropdownFix(),
              t(i).trigger("kt-datatable--on-init", {
                table: t(i.wrap).attr("id"),
                options: o,
              }),
              (l.isInit = !0)),
            t(i).trigger("kt-datatable--on-layout-updated", {
              table: t(i.wrap).attr("id"),
            });
        },
                      ...
                      !(function (a) {
                        if (t(a).find(".kt-datatable__lock").length > 0)
                          ...
                          t(a)
                            ...
                            .each(function () {
                              var e = t("<tr/>")
                                  .addClass("kt-datatable__row")
                                  .data("obj", t(this).data("obj"))
                                  .appendTo(n),
                                a = t("<tr/>")
                                  .addClass("kt-datatable__row")
                                  .data("obj", t(this).data("obj"))
                              ...
                              t(this)
                                ...
                                .each(function () {
                                  ...
                                  void 0 !== n
                                    ? ((void 0 === n.left && !0 !== n) ||
                                        t(this).appendTo(e),
                                      void 0 !== n.right && t(this).appendTo(i))
                                    : t(this).appendTo(a);
                                }),
                                t(this).remove();
                            }),
                            e.lockEnabled.left.length > 0 &&
                              (t(i.wrap).addClass("kt-datatable--lock"),
                              t(n).appendTo(a)),
                            (e.lockEnabled.left.length > 0 ||
        ...
        fullRender: function () {
          t(i.tableHead).empty(),
            ...
            l.getOption("layout.footer") &&
              (t(i.tableFoot).empty(), l.setHeadTitle(i.tableFoot)),
            l.spinnerCallback(!0),
            t(i.wrap).removeClass("kt-datatable--loaded"),
            l.insertData();
        },
        ...
        afterRender: function (e, a) {
          t(i).ready(function () {
            l.isLocked() && l.redraw(),
              t(i.tableBody).css("visibility", ""),
              t(i.wrap).addClass("kt-datatable--loaded"),
              l.spinnerCallback(!1);
          });
        },
        hoverTimer: 0,
          ...
          t(window).scroll(function (t) {
            ...
            t(i.tableBody)
              ...
              .on("mouseenter", function () {
                if (
                  ...
                  var e = t(this)
                      ...
                      .addClass("kt-datatable__row--hover"),
                    a = t(e).index() + 1;
                  t(e)
                    .closest(".kt-datatable__lock")
                    .parent()
                    .find(".kt-datatable__row:nth-child(" + a + ")")
                    .addClass("kt-datatable__row--hover");
                }
              })
              .on("mouseleave", function () {
                var e = t(this)
                    .closest(".kt-datatable__row")
                    .removeClass("kt-datatable__row--hover"),
                  a = t(e).index() + 1;
                t(e)
                  .closest(".kt-datatable__lock")
                  .parent()
        ...
        adjustLockContainer: function () {
          ...
          return (
            t(i.table).find(".kt-datatable__lock--scroll").css("width", o), o
          );
        },
        dragResize: function () {
          var e,
          ...
          t(i.tableHead)
            ...
            .mousedown(function (i) {
              (o = t(this)),
                ...
                (e = i.pageX),
                (a = t(this).width()),
                t(o).addClass("kt-datatable__cell--resizing");
            })
        ...
        initHeight: function () {
          if (o.layout.height && o.layout.scroll) {
            ...
            e > 0 && (n -= e),
              a > 0 && (n -= a),
              (n -= 2),
              t(i.tableBody).css("max-height", n),
              t(i.tableBody)
          ...
          (i.initialDatatable = t(i).clone()),
            "TABLE" === t(i).prop("tagName")
              ? ((i.table = t(i)
                ...
                0 === t(i.table).parents(".kt-datatable").length &&
                  (i.table.wrap(
                    t("<div/>")
                      .addClass("kt-datatable")
                      .addClass("kt-datatable--" + o.layout.theme)
                  ),
            ...
            void 0 === t(i).attr("id") &&
              ...
              t(i.table).attr("id", a.getUniqueID("kt-datatable--"))),
            l.getOption("layout.minHeight") &&
              t(i.table).css("min-height", l.getOption("layout.minHeight")),
            l.getOption("layout.height") &&
              t(i.table).css("max-height", l.getOption("layout.height")),
            null === o.data.type &&
              t(i.table).css("width", "").css("display", ""),
            (i.tableHead = t(i.table).find("thead")),
            0 === t(i.tableHead).length &&
              (i.tableHead = t("<thead/>").prependTo(i.table)),
            (i.tableBody = t(i.table).find("tbody")),
            0 === t(i.tableBody).length &&
              (i.tableBody = t("<tbody/>").appendTo(i.table)),
            void 0 !== o.layout.footer &&
              o.layout.footer &&
              ((i.tableFoot = t(i.table).find("tfoot")),
              0 === t(i.tableFoot).length &&
                (i.tableFoot = t("<tfoot/>").appendTo(i.table)));
        },
                    ...
                    .each(function (n, r) {
                      ...
                      if (void 0 !== s && void 0 !== s.template) {
                        ...
                        "string" == typeof s.template &&
                          (d = l.dataPlaceholder(s.template, o)),
          ...
          if (((i.dataSet = i.dataSet || []), 0 !== i.dataSet.length)) {
                  ...
                  .each(function (a, n) {
                    ...
                    if (void 0 !== o) {
                      ...
                      if (void 0 !== o.selector && !1 !== o.selector) {
                        if (
                          t(n).find('.kt-checkbox [type="checkbox"]').length > 0
                        )
                          return;
                        t(n).addClass("kt-datatable__cell--check");
                        var r = t("<label/>")
                          .addClass("kt-checkbox kt-checkbox--single")
                          .append(
                            t("<input/>")
                              .attr("type", "checkbox")
                              .attr("value", i)
                          ...
                          .append("&nbsp;<span></span>");
                        void 0 !== o.selector.class &&
                          t(r).addClass(o.selector.class),
                          t(n).children().html(r);
                      }
                      if (void 0 !== o.subtable && o.subtable) {
                        if (
                          t(n).find(".kt-datatable__toggle-subtable").length > 0
                        )
                          return;
                        t(n)
                          .children()
                          .html(
                            t("<a/>")
                              .addClass("kt-datatable__toggle-subtable")
                              .attr("href", "#")
                              .attr("data-value", i)
                              .append(
                                t("<i/>").addClass(
                                  l.getOption("layout.icons.rowDetail.collapse")
                                )
                              )
                          );
                      }
            ...
            var a = function (a) {
              ...
              if (void 0 !== n && void 0 !== n.selector && !1 !== n.selector) {
                ...
                if (t(o).find('.kt-checkbox [type="checkbox"]').length > 0)
                  return;
                t(o).addClass("kt-datatable__cell--check");
                var i = t("<label/>")
                  .addClass("kt-checkbox kt-checkbox--single kt-checkbox--all")
                  .append(
                    t("<input/>")
                      .attr("type", "checkbox")
                      .on("click", function () {
                  ...
                  .append("&nbsp;<span></span>");
                void 0 !== n.selector.class && t(i).addClass(n.selector.class),
                  t(o).children().html(i);
              }
            };
            o.layout.header &&
              a(t(i.tableHead).find(".kt-datatable__row").first()),
              o.layout.footer &&
                a(t(i.tableFoot).find(".kt-datatable__row").first());
          }
        },
        maxWidthList: {},
                  ...
                  if (void 0 !== r)
                    if ("auto" === r) {
                      ...
                      if (l.maxWidthList[s]) o = l.maxWidthList[s];
                        ...
                        var d = t(i.table).find(
                          '.kt-datatable__cell[data-field="' + s + '"]'
                        );
        ...
        setupDOM: function (e) {
          t(e).find("> thead").addClass("kt-datatable__head"),
            ...
            t(e).find("tr > th, tr > td").addClass("kt-datatable__cell"),
            t(e)
              .find("tr > th, tr > td")
              .each(function (e, a) {
                0 === t(a).find("span").length &&
                  t(a).wrapInner(t("<span/>").css("width", l.cellOffset));
              });
        },
        scrollbar: function () {
          var e = {
            ...
            init: function () {
              ...
              if (o.layout.scroll) {
                ...
                t(r).find(".kt-datatable__row").length > 0 && t(r).length > 0
                  ? ((e.scrollHead = t(i.tableHead).find(
                      "> .kt-datatable__lock--scroll > .kt-datatable__row"
                    )),
                    (e.scrollFoot = t(i.tableFoot).find(
                      "> .kt-datatable__lock--scroll > .kt-datatable__row"
                    )),
                    (e.tableLocked = t(i.tableBody).find(
                      ".kt-datatable__lock:not(.kt-datatable__lock--scroll)"
                    )),
                    l.getOption("layout.customScrollbar") &&
                    10 != a.detectIE() &&
                    n > a.getBreakpoint("lg")
                      ? e.initCustomScrollbar(r[0])
                      : e.initDefaultScrollbar(r))
                  : t(i.tableBody).find(".kt-datatable__row").length > 0 &&
                    ((e.scrollHead = t(i.tableHead).find(
                      "> .kt-datatable__row"
                    )),
                    (e.scrollFoot = t(i.tableFoot).find(
                    ...
                    10 != a.detectIE() &&
                    n > a.getBreakpoint("lg")
                      ? e.initCustomScrollbar(i.tableBody)
                      : e.initDefaultScrollbar(i.tableBody));
              }
            },
        ...
        initScrollbar: function (e, n) {
          if (e && e.nodeName)
            if ((t(i.tableBody).css("overflow", ""), a.hasClass(e, "ps")))
              t(e).data("ps").update();
            else {
              var o = new PerfectScrollbar(
                e,
                Object.assign(
                  {},
                  {
                    ...
                    maxScrollbarLength: 300,
                    suppressScrollX:
                      l.getOption("rows.autoHide") && !l.isLocked(),
                  },
                  n
                )
              );
        ...
        setHeadTitle: function (e) {
          ...
          void 0 === r &&
            ((r = document.createElement("tr")), e.appendChild(r)),
            t.each(n, function (e, n) {
              var o = s[e];
              if (
                (void 0 === o &&
                  ((o = document.createElement("th")), r.appendChild(o)),
                void 0 !== n.title &&
                  ((o.innerHTML = n.title),
                  ...
                  void 0 !== n.autoHide &&
                    (!0 !== n.autoHide
                      ? o.setAttribute("data-autohide-disabled", n.autoHide)
                      : o.setAttribute("data-autohide-enabled", n.autoHide)),
                  t(o).data(n)),
                void 0 !== n.attr &&
                ...
                var l =
                  void 0 !== i.textAlign[n.textAlign]
                    ? i.textAlign[n.textAlign]
                    : "";
                a.addClass(o, l);
              }
            }),
        ...
        dataRender: function (e) {
          ...
          var a = function () {
              ...
              0 === e.perpage && (e.perpage = o.data.pageSize || 10),
                (e.total = i.dataSet.length);
            ...
            n = function (e) {
              var n = function (e, a) {
                t(e.pager).hasClass("kt-datatable--paging-loaded") ||
                  (t(e.pager).remove(), e.init(a)),
                  t(e.pager)
                    .off()
                    .on("kt-datatable--on-goto-page", function (n) {
                      t(e.pager).remove(), e.init(a);
                    });
                var n = Math.max(a.perpage * (a.page - 1), 0),
                  o = Math.min(n + a.perpage, a.total);
                l.localDataUpdate(),
                  (i.dataSet = t(i.dataSet).slice(n, o)),
                  l.insertData();
              };
          ...
          "local" === o.data.type ||
          (!1 === o.data.serverSorting && "sort" === e) ||
          (!1 === o.data.serverFiltering && "search" === e)
            ? setTimeout(function () {
                n(), l.setAutoColumns();
              })
            : l.getData().done(n);
        ...
        insertData: function () {
          ...
          var e = l.getDataSourceParam(),
            ...
            d = {};
          void 0 !== o.data.attr.rowProps &&
            o.data.attr.rowProps.length &&
            (d = o.data.attr.rowProps.slice(r, s));
          ...
          if (
            (t.each(i.dataSet, function (n, r) {
              ...
              for (var p = 0; p < u; p += 1) {
                var f = o.columns[p],
                  g = [];
                if (
                  (l.getObject("sort.field", e) === f.field &&
                    g.push("kt-datatable__cell--sorted"),
                  void 0 !== f.textAlign)
                ) {
                  var h =
                    void 0 !== i.textAlign[f.textAlign]
                ...
                a.addClass(v, g.join(" ")),
                  ...
                  void 0 !== f.autoHide &&
                    (!0 !== f.autoHide
                      ? v.setAttribute("data-autohide-disabled", f.autoHide)
                      : v.setAttribute("data-autohide-enabled", f.autoHide)),
            ...
            a.addClass(p, "kt-datatable--error"),
              ...
              c.appendChild(p),
              t(i.wrap).addClass("kt-datatable--error kt-datatable--loaded"),
              l.spinnerCallback(!1);
          }
          t(i.tableBody).replaceWith(c),
            (i.tableBody = c),
            l.setupDOM(i.table),
            l.setupCellField([i.tableBody]),
            l.setupTemplateCell(i.tableBody),
            l.layoutUpdate();
        },
        updateTableComponents: function () {
          (i.tableHead = t(i.table).children("thead")),
            (i.tableBody = t(i.table).children("tbody")),
            (i.tableFoot = t(i.table).children("tfoot"));
        },
        getData: function () {
          var e = {
            dataType: "json",
          ...
          if (
            ("local" === o.data.type && (e.url = o.data.source),
            "remote" === o.data.type)
          ) {
            ...
            l.getOption("data.serverPaging") || delete a.pagination,
              ...
              "string" !=
                typeof (e = t.extend({}, e, l.getOption("data.source.read")))
                  .url && (e.url = l.getOption("data.source.read")),
          ...
          return t
            ...
            .done(function (e, a, n) {
              (i.lastResponse = e),
                (i.dataSet = i.originalDataSet = l.dataMapCallback(e)),
                l.setAutoColumns(),
                t(i).trigger("kt-datatable--on-ajax-done", [i.dataSet]);
            })
            .fail(function (e, a, n) {
              t(i).trigger("kt-datatable--on-ajax-fail", [e]),
                t(i.tableBody).html(
                  t("<span/>")
                    .addClass("kt-datatable--error")
                    .html(l.getOption("translate.records.noRecords"))
                ),
                t(i.wrap).addClass("kt-datatable--error kt-datatable--loaded"),
                l.spinnerCallback(!1);
            })
          ...
          var o = {
            ...
            init: function (e) {
              (o.meta = e),
                ...
                (o.meta.pages = Math.max(
                  Math.ceil(o.meta.total / o.meta.perpage),
                  1
                )),
                o.meta.page > o.meta.pages && (o.meta.page = o.meta.pages),
                (o.paginateEvent = l.getTablePrefix("paging")),
                (o.pager = t(i.table).siblings(".kt-datatable__pager")),
                t(o.pager).hasClass("kt-datatable--paging-loaded") ||
                  (t(o.pager).remove(),
                  0 !== o.meta.pages &&
            ...
            populate: function () {
              ...
              (o.pagerLayout.pagination = n),
                ...
                t("<li/>")
                  .append(
                    t("<input/>")
                      .attr("type", "text")
                      .addClass("kt-pager-input form-control")
                      .attr("title", a.input)
                      .on("keyup", function () {
              ...
              t("<li/>")
                ...
                l.getOption("toolbar.items.info") &&
                  (o.pagerLayout.info = t("<div/>")
                    .addClass("kt-datatable__pager-info")
                    .append(
                      t("<span/>").addClass("kt-datatable__pager-detail")
                    )),
                t.each(l.getOption("toolbar.layout"), function (e, a) {
                  t(o.pagerLayout[a]).appendTo(o.pager);
                });
              var p = t("<select/>")
                  .addClass("selectpicker kt-datatable__pager-size")
                  .attr(
                    "title",
                    l.getOption(
            ...
            paste: function () {
              t.each(
                ...
                function (e, a) {
                  "bottom" === a && t(o.pager).clone(!0).insertAfter(i.table),
                    "top" === a &&
                      t(o.pager)
                        .clone(!0)
                        .addClass("kt-datatable__pager--top")
                        .insertBefore(i.table);
                }
              );
            },
            gotoMorePage: function (e) {
              if ((e.preventDefault(), "disabled" === t(this).attr("disabled")))
                return !1;
              var a = t(this).attr("data-page");
              return (
                void 0 === a && (a = t(e.target).attr("data-page")),
                o.openPage(parseInt(a)),
                !1
              );
            },
            gotoPage: function (e) {
              e.preventDefault(),
                t(this).hasClass("kt-datatable__pager-link--active") ||
                  o.openPage(parseInt(t(this).data("page")));
            },
            openPage: function (e) {
              (o.meta.page = parseInt(e)),
                t(i).trigger(o.paginateEvent, o.meta),
                o.callback(o, o.meta),
                t(o.pager).trigger("kt-datatable--on-goto-page", o.meta);
            },
            updatePerpage: function (e) {
              e.preventDefault(),
                ...
                t(o.pager)
                  ...
                  .val(o.meta.perpage)
                  .attr("data-selected", o.meta.perpage),
                l.setDataSourceParam("pagination", {
                  page: o.meta.page,
                  pages: o.meta.pages,
                  perpage: o.meta.perpage,
                ...
                t(o.pager).trigger("kt-datatable--on-update-perpage", o.meta),
                t(i).trigger(o.paginateEvent, o.meta),
                o.callback(o, o.meta),
                o.updateInfo.call();
            },
            addPaginateEvent: function (e) {
              t(i)
                ...
                .on(o.paginateEvent, function (e, a) {
                  ...
                  t(n)
                    .find(".kt-datatable__pager-link--active")
                    .removeClass("kt-datatable__pager-link--active"),
                    t(n)
                      .find(
                    ...
                    t(n)
                      .find(".kt-datatable__pager-link--prev")
                      .attr("data-page", Math.max(a.page - 1, 1)),
                    t(n)
                      .find(".kt-datatable__pager-link--next")
                      .attr("data-page", Math.min(a.page + 1, a.pages)),
                    t(o.pager).each(function () {
                      t(this)
                        .find('.kt-pager-input[type="text"]')
                        .prop("value", a.page);
                    }),
                    t(o.pager).find(".kt-datatable__pager-nav").show(),
                    a.pages <= 1 &&
                      t(o.pager).find(".kt-datatable__pager-nav").hide(),
                    l.setDataSourceParam("pagination", {
                      page: o.meta.page,
                      pages: o.meta.pages,
                      perpage: o.meta.perpage,
                    ...
                    t(o.pager)
                      .find("select.kt-datatable__pager-size")
                      .val(a.perpage)
                      .attr("data-selected", a.perpage),
                    t(i.table)
                      .find('.kt-checkbox > [type="checkbox"]')
                      .prop("checked", !1),
                    t(i.table)
                      .find(".kt-datatable__row--active")
            ...
            updateInfo: function () {
              ...
              t(o.pager)
                ...
                .html(
                  l.dataPlaceholder(
                    l.getOption("translate.toolbar.pagination.items.info"),
                    {
                      start: e,
                      end: -1 === o.meta.perpage ? o.meta.total : a,
                      pageSize:
                        -1 === o.meta.perpage || o.meta.perpage >= o.meta.total
                          ? o.meta.total
                          : o.meta.perpage,
                      total: o.meta.total,
                    }
            ...
            pagingBreakpoint: function () {
              ...
              if (0 !== t(e).length) {
                ...
                t(e).find("li").show(),
                  t.each(
                    l.getOption("toolbar.items.pagination.pages"),
                    function (i, s) {
                        ...
                        switch (i) {
                          ...
                          case "tablet":
                            Math.ceil(n / s.pagesNumber),
                              ...
                              s.pagesNumber;
                            t(r).hide(),
                              (o.meta = l.getDataSourceParam("pagination")),
                              o.paginationUpdate();
                            break;
                          case "mobile":
                            t(r).show(),
                              t(e)
                                .find(".kt-datatable__pager-link--more-prev")
                                .closest("li")
                                .hide(),
                              t(e)
                                .find(".kt-datatable__pager-link--more-next")
                                .closest("li")
                                .hide(),
                              t(e)
                                .find(".kt-datatable__pager-link-number")
                                .closest("li")
                                .hide();
                        }
                        return !1;
            ...
            paginationUpdate: function () {
              ...
              t(n).each(function (e, a) {
                ...
                f === o.meta.pages && f === t(u).last().data("page")
                  ? t(n).parent().hide()
                  : t(n).parent().show(),
                1 === o.meta.page
                  ? (t(r)
                      .attr("disabled", !0)
                      .addClass("kt-datatable__pager-link--disabled"),
                    t(s)
                      .attr("disabled", !0)
                      .addClass("kt-datatable__pager-link--disabled"))
                  : (t(r)
                      .removeAttr("disabled")
                      .removeClass("kt-datatable__pager-link--disabled"),
                    t(s)
                      .removeAttr("disabled")
                      .removeClass("kt-datatable__pager-link--disabled")),
        ...
        columnHide: function () {
          ...
          t.each(o.columns, function (n, o) {
            if (void 0 !== o.responsive) {
              var l = o.field,
                r = t.grep(
                  t(i.table).find(".kt-datatable__cell"),
                  function (e, a) {
                    return l === t(e).data("field");
                  }
                );
              a.getBreakpoint(o.responsive.hidden) >= e
                ? t(r).hide()
                : t(r).show(),
                a.getBreakpoint(o.responsive.visible) <= e
                  ? t(r).show()
                  : t(r).hide();
            }
          });
        ...
        setupSubDatatable: function () {
          ...
          if (
            "function" == typeof e &&
            !(t(i.table).find(".kt-datatable__subtable").length > 0)
          ) {
            t(i.wrap).addClass("kt-datatable--subtable"),
              (o.columns[0].subtable = !0);
            var a = function (a) {
                a.preventDefault();
                ...
                0 === t(r).length &&
                  ((r = t("<tr/>")
                    ...
                    .append(
                      t("<td/>")
                        .addClass("kt-datatable__subtable")
                        .attr("colspan", l.getTotalColumns())
                    )),
                  t(n).after(r),
                  t(n).hasClass("kt-datatable__row--even") &&
                    t(r).addClass("kt-datatable__row-subtable--even")),
                  t(r).toggle();
                var s = t(r).find(".kt-datatable__subtable"),
                  d = t(this)
                    .closest("[data-field]:first-child")
                    .find(".kt-datatable__toggle-subtable")
                    .data("value"),
                  c = t(this).find("i").removeAttr("class");
                t(n).hasClass("kt-datatable__row--subtable-expanded")
                  ? (t(c).addClass(
                      l.getOption("layout.icons.rowDetail.collapse")
                    ),
                    t(n).removeClass("kt-datatable__row--subtable-expanded"),
                    t(i).trigger("kt-datatable--on-collapse-subtable", [n]))
                  : (t(c).addClass(
                      l.getOption("layout.icons.rowDetail.expand")
                    ),
                    t(n).addClass("kt-datatable__row--subtable-expanded"),
                    t(i).trigger("kt-datatable--on-expand-subtable", [n])),
                  0 === t(s).find(".kt-datatable").length &&
                    ...
                    t(s)
                      ...
                      .on("kt-datatable--on-init", function (e) {
                        t(r).removeClass("kt-datatable__row-loading");
                      }),
                    "local" === l.getOption("data.type") &&
                      t(r).removeClass("kt-datatable__row-loading"));
              },
              n = o.columns;
            t(i.tableBody)
                  ...
                  .each(function (e, o) {
                    ...
                    if (void 0 !== i) {
                      ...
                      if (void 0 !== i.subtable && i.subtable) {
                        if (
                          t(o).find(".kt-datatable__toggle-subtable").length > 0
                        )
                          return;
                        t(o).html(
                          t("<a/>")
        ...
        dataMapCallback: function (t) {
          var e = t;
          return "function" == typeof l.getOption("data.source.read.map")
          ...
          void 0 !== a &&
            ...
            (t
              ? l.isSpinning ||
                (void 0 !== a.message &&
                  !0 === a.message &&
                  (a.message = l.getOption("translate.records.processing")),
                (l.isSpinning = !0),
        ...
        autoHide: function () {
          ...
          var n = function (e) {
            ...
            if (t(n).hasClass("kt-datatable__row-detail"))
              t(this)
                .find("i")
                .removeClass(l.getOption("layout.icons.rowDetail.expand"))
                .addClass(l.getOption("layout.icons.rowDetail.collapse")),
                t(n).remove();
            else {
              t(this)
                .find("i")
                .removeClass(l.getOption("layout.icons.rowDetail.collapse"))
                .addClass(l.getOption("layout.icons.rowDetail.expand"));
              ...
              t(i).each(function () {
                ...
                t(s).append(
                  t('<tr class="kt-datatable__row"></tr>')
                    .append(
                      t('<td class="kt-datatable__cell"></td>').append(
                        t("<span/>").append(a.title)
                      )
                    )
                    .append(this)
                );
          ...
          setTimeout(function () {
            t(i.table).find(".kt-datatable__cell").show(),
              t(i.tableBody).each(function () {
                for (
                  var a = 0;
                  t(this)[0].offsetWidth < t(this)[0].scrollWidth &&
                  a < o.columns.length;
              ...
              e &&
                t(i.tableBody)
                  .find(".kt-datatable__row")
                  .each(function () {
                    0 === t(this).find(".kt-datatable__toggle-detail").length &&
                      t(this).prepend(
                        t("<td/>")
                          .addClass(
                      ...
                      0 ===
                      t(i.tableHead).find(".kt-datatable__toggle-detail").length
                        ? (t(i.tableHead)
                            .find(".kt-datatable__row")
                            .first()
                            .prepend(
                        ...
                        : t(i.tableHead)
                            .find(".kt-datatable__toggle-detail")
                            .find("span");
                  });
          }),
        ...
        setAutoColumns: function () {
          l.getOption("data.autoColumns") &&
            ...
            t(i.tableHead).find(".kt-datatable__row").remove(),
            l.setHeadTitle(),
            l.getOption("layout.footer") &&
              (t(i.tableFoot).find(".kt-datatable__row").remove(),
        ...
        getExtraSpace: function (e) {
          return (
            ...
            Math.ceil(t(e).css("border-right-width").replace("px", ""))
          );
        },
        ...
        stateGet: function (t, e) {
          if (
            ((t = l.getTablePrefix(t)), !1 !== l.getOption("data.saveState"))
          ) {
            var a = null;
            return null !=
              (a =
                l.getOption("data.saveState.webstorage") && localStorage
        ...
        getTotalColumns: function (e) {
          return (
            void 0 === e && (e = i.tableBody),
            t(e).find(".kt-datatable__row").first().find(".kt-datatable__cell")
              .length
          );
        },
        ...
        sortColumn: function (e, a, n) {
          ...
          -1 !== r &&
            (l = t(i.tableBody)
              .find(".kt-datatable__lock:nth-child(" + (r + 1) + ")")
              .find(".kt-datatable__row"));
          var s = t(l).parent();
          t(l)
            .sort(function (e, i) {
        ...
        sorting: function () {
          var e = {
            init: function () {
              o.sortable &&
                (t(i.tableHead)
                  .find(".kt-datatable__cell:not(.kt-datatable__cell--check)")
            ...
            setIcon: function () {
              ...
              if (!t.isEmptyObject(e)) {
                ...
                if (
                  ...
                  var n = t(i.tableHead)
                      .find('.kt-datatable__cell[data-field="' + e.field + '"]')
                      .attr("data-sort", e.sort),
                    o = t(n).find("span"),
                    r = t(o).find("i"),
                    s = l.getOption("layout.icons.sort");
                  t(r).length > 0
                    ? t(r).removeAttr("class").addClass(s[e.sort])
                    : t(o).append(t("<i/>").addClass(s[e.sort])),
                    t(n).addClass("kt-datatable__cell--sorted");
                }
              }
            },
            sortClick: function (n) {
              ...
              if (
                ...
                (t(i.tableHead)
                  .find("th")
                  .removeClass("kt-datatable__cell--sorted"),
                a.addClass(this, "kt-datatable__cell--sorted"),
                t(i.tableHead).find(".kt-datatable__cell > span > i").remove(),
                o.sortable)
              ) {
                l.spinnerCallback(!0);
                var c = "desc";
                l.getObject("field", r) === s && (c = l.getObject("sort", r)),
                  ...
                  setTimeout(function () {
                    l.dataRender("sort"),
                      t(i).trigger("kt-datatable--on-sort", r);
                  }, 300);
              }
            },
          };
                ...
                if (void 0 !== a && a) {
                  ...
                  e.forEach(function (t, e) {
                    (t.toString().toLowerCase() != n &&
                      -1 === n.indexOf(t.toString().toLowerCase())) ||
                      d++;
                  });
                }
              }),
        ...
        resetScroll: function () {
          void 0 === o.detail &&
            1 === l.getDepth() &&
            (t(i.table).find(".kt-datatable__row").css("left", 0),
            t(i.table).find(".kt-datatable__lock").css("top", 0),
            t(i.tableBody).scrollTop(0));
        },
          ...
          return (
            t.each(o.columns, function (a, n) {
              if (
                ...
                return (e = { sort: n.sortable, field: n.field }), !1;
            }),
            e
          );
        },
        ...
        rowEvenOdd: function () {
          t(i.tableBody)
            ...
            t(i.wrap).hasClass("kt-datatable--subtable")
              ? t(i.tableBody)
                  .find(
              ...
              : t(i.tableBody)
                  .find(".kt-datatable__row:nth-child(even)")
                  .addClass("kt-datatable__row--even");
        },
        timer: 0,
        redraw: function () {
          return (
            l.adjustCellsWidth.call(),
            l.isLocked() &&
              (l.scrollbar(), l.resetScroll(), l.adjustCellsHeight.call()),
          ...
          return (
            (function (t, e) {
              ...
              o.data.serverFiltering || l.localDataUpdate(),
                l.dataRender(),
                t(i).trigger("kt-datatable--on-reloaded");
            ...
            t(i.tableBody)
              ...
              .each(function (a, n) {
                if (e == t(n).text()) {
                  ...
                  return (
                    (i.API.record = i.API.value = l.getOneRow(i.tableBody, o)),
                    i
                  );
                }
              }),
        ...
        getColumn: function (e) {
          return (
            ...
            (i.API.value = t(i.API.record).find('[data-field="' + e + '"]')),
            i
          );
        },
        destroy: function () {
          t(i).parent().find(".kt-datatable__pager").remove();
          var e = t(i.initialDatatable)
            .addClass("kt-datatable--destroyed")
            .show();
          return (
            t(i).replaceWith(e),
            t((i = e)).trigger("kt-datatable--on-destroy"),
            (l.isInit = !1),
            (e = null)
          );
        },
        sort: function (e, a) {
          ...
          return (
            ...
            setTimeout(function () {
              l.dataRender("sort"),
                t(i).trigger("kt-datatable--on-sort", n),
                t(i.tableHead).find(".kt-datatable__cell > span > i").remove();
            }, 300),
            i
          );
        ...
        setActive: function (e) {
          "string" == typeof e &&
            (e = t(i.tableBody).find(
              '.kt-checkbox--single > [type="checkbox"][value="' + e + '"]'
            )),
            t(e).prop("checked", !0);
          var a = [];
        ...
        setActiveAll: function (e) {
          var a = t(i.table)
            ...
            .find("tr")
            .not(".kt-datatable__row-subtable")
            .find('.kt-datatable__cell--check [type="checkbox"]');
          e ? l.setActive(a) : l.setInactive(a);
        },
        setSelectedRecords: function () {
          return (
            (i.API.record = t(i.tableBody).find(".kt-datatable__row--active")),
            i
          );
        },
        getSelectedRecords: function () {
          return (
            l.setSelectedRecords(),
            (i.API.record = i.rows(".kt-datatable__row--active").nodes()),
            i.API.record
          );
        },
        ...
        search: function (e, a) {
          void 0 !== a && (a = t.makeArray(a)),
            ...
            (i = l.getOption("search.delay")),
            clearTimeout(l.timer),
            (l.timer = setTimeout(n, i));
          var n, i;
        },
        setDataSourceParam: function (e, a) {
          (i.API.params = t.extend(
            {},
            {
              pagination: { page: 1, perpage: l.getOption("data.pageSize") },
          ...
          return (
            l.isLocked()
              ? (l.nodeTr = l.recentNode =
                  t(i.tableBody)
                    .find(e)
                    .filter(".kt-datatable__lock--scroll > .kt-datatable__row"))
              : (l.nodeTr = l.recentNode =
                  t(i.tableBody).find(e).filter(".kt-datatable__row")),
            i
          );
        },
        column: function (e) {
          return (
            (l.nodeCols = l.recentNode =
              t(i.tableBody).find(
                ".kt-datatable__cell:nth-child(" + (e + 1) + ")"
              )),
            i
          );
        },
        columns: function (e) {
          ...
          return (
            n.length > 0
              ...
              : (l.nodeCols = l.recentNode =
                  t(a).find(e).filter(".kt-datatable__cell")),
            i
          );
        },
        cell: function (e) {
        ...
        visible: function (e) {
          if (t(l.recentNode.length)) {
            ...
            if (l.recentNode === l.nodeCols) {
              ...
              if (l.isLocked()) {
                var i = t(l.recentNode).closest(
                  ".kt-datatable__lock--scroll"
                ).length;
                i
                  ? (n += a.left.length + 1)
                  : t(l.recentNode).closest(".kt-datatable__lock--right")
                      .length && (n += a.left.length + i + 1);
              }
            }
            e
              ? (l.recentNode === l.nodeCols && delete o.columns[n].responsive,
                t(l.recentNode).show())
              : (l.recentNode === l.nodeCols &&
                  l.setOption("columns." + n + ".responsive", { hidden: "xl" }),
                t(l.recentNode).hide()),
              l.redraw();
          }
        },
      ...
      if (
        ...
        if ("string" == typeof o) {
          ...
          i.data(e) ||
            ...
            (o = t.extend(!0, {}, t.fn.KTDatatable.defaults, o)),
            (i.options = o),
            l.init.apply(this, [o]),
            t(i.wrap).data(e, i));
      else
      ...
      toolbar: {
        ...
        items: {
          pagination: {
            ...
            navigation: { prev: !0, next: !0, first: !0, last: !0, more: !1 },
            pageSizeSelect: [],
          },
          info: !0,
        },
    ...
    (t.fn.KTDatatable = t.fn.KTDatatable || {}),
      (t.fn.KTDatatable.checkbox = function (e, a) {
        var n = {
          ...
          init: function () {
            n.selectorEnabled() &&
              ...
              t(e).on("kt-datatable--on-layout-updated", function (a, o) {
            ...
            t(e.tableHead)
              ...
              .click(function (o) {
                ...
                e.setDataSourceParam(a.vars.selectedAllRows, n.selectedAllRows),
                  t(e).trigger("kt-datatable--on-click-checkbox", [t(this)]);
              }),
              t(e.tableBody)
                .find('.kt-checkbox--single > [type="checkbox"]')
                .click(function (o) {
        ...
        return (
          ...
          "object" == typeof a &&
            ((a = t.extend(!0, {}, t.fn.KTDatatable.checkbox.default, a)),
            n.init.apply(this, [a])),
          e
        );
      }),
    ...
    if (e) {
          ...
          return (
            ...
            i &&
              (a =
                ...
                parseInt(KTUtil.css(i, "padding-top")) -
                parseInt(KTUtil.css(i, "padding-bottom"))),
            l &&
              (a =
      ...
      var a = function () {
        ...
        if (0 !== n.value.length) {
          ...
          KTUtil.addClass(o, "kt-chat__message kt-chat__message--right");
          var i,
            l =
              '<div class="kt-chat__user"><span class="kt-chat__datetime">Just now</span><a href="#" class="kt-chat__username">Jason Muller</span></a><span class="kt-userpic kt-userpic--circle kt-userpic--sm"><img src="<?php echo base_url(); ?>assets/media/users/100_12.jpg" alt="image"></span></div><div class="kt-chat__text kt-bg-light-brand">' +
              n.value;
          KTUtil.setHTML(o, l),
            a.appendChild(o),
            (n.value = ""),
      ...
      !(function () {
        ...
        KTUtil.scrollInit(n, {
          ...
          height: function () {
            ...
            return (
              a &&
                ((t -= parseInt(KTUtil.actualHeight(a))),
                (t -= parseInt(KTUtil.css(a, "marginBottom")))),
          ...
          height: function () {
            ...
            return (
              e &&
                ...
                (a -= parseInt(KTUtil.css(e, "marginBottom")))),
            ...
            height: function () {
              ...
              return (
                t &&
                  ...
                  (a -= parseInt(KTUtil.css(t, "marginBottom")))),
            ...
            height: function () {
              ...
              return (
                t &&
                  ...
                  (e -= parseInt(KTUtil.css(t, "marginBottom")))),
    ...
    var t,
      ...
      g = function () {
        (u = !1),
          ...
          n && (a.value.length < 2 ? KTUtil.hide(n) : KTUtil.show(n, "flex"));
      },
      h = function () {
        l &&
          !KTUtil.hasClass(i, "show") &&
      ...
      m = function () {
        if (d && s === a.value)
          return g(), KTUtil.addClass(t, f), h(), void KTUtil.scrollUpdate(o);
        (s = a.value),
    ...
    return {
      init: function (s) {
        (t = s),
          ...
          (o = KTUtil.find(t, ".kt-quick-search__wrapper")),
          (i = KTUtil.find(t, ".dropdown-menu")),
        ...
        d &&
          $(d).on("shown.bs.dropdown", function () {
            a.focus();
          });
      },
    };
...
$(document).ready(function () {
  KTUtil.get("kt_quick_search_default") &&
      ...
      return new KTPortlet("kt_page_portlet", {
        sticky: {
          ...
          position: {
            top: function () {
              return KTUtil.isInResponsiveRange("desktop")
                ? parseInt(KTUtil.css(KTUtil.get("kt_header"), "height"))
                : parseInt(
  ...
  return {
    init: function () {
      KTUtil.get("body"),
        ...
        $("#kt_aside_menu, #kt_header_menu").on(
          ...
          '.kt-menu__link[href="#"]',
          function () {
            location.hostname.match("keenthemes.com")
              ? swal.fire(
    ...
    initHeader: function () {
      ...
      (n = KTUtil.get("kt_header")),
        ...
        "on" == KTUtil.attr(n, "data-ktheader-minimize")
          ? ((o.minimize.desktop = {}),
            (o.minimize.desktop.on = "kt-header--minimize"),
            (o.offset.desktop = parseInt(KTUtil.css(n, "height")) - 10))
          : (o.minimize.desktop = !1),
        (t = new KTHeader("kt_header", o)),
        a &&
          (t.on("minimizeOn", function () {
            a.scrollReInit();
          }),
        ...
        new KTScrolltop("kt_scrolltop", { offset: 200, speed: 400 });
    },
    initAside: function () {
      var t, e, n, o, i;
      (t = KTUtil.get("kt_aside")),
        KTUtil.get("kt_aside_brand"),
        (e = KTUtil.hasClass(t, "kt-aside--offcanvas-default")
          ? "kt-aside--offcanvas-default"
          : "kt-aside"),
        new KTOffcanvas("kt_aside", {
          baseClass: e,
          overlay: !0,
          ...
          toggleBy: [
            ...
            { target: "kt_aside_toggler", state: "kt-aside-toggler--active" },
          ],
        }),
        (o = KTUtil.get("kt_aside_menu")),
        (i =
          "1" === KTUtil.attr(o, "data-ktmenu-dropdown")
            ? "dropdown"
            : "accordion"),
        "1" === KTUtil.attr(o, "data-ktmenu-scroll") &&
          (n = {
            rememberPosition: !0,
            height: function () {
              return KTUtil.isInResponsiveRange("desktop")
                ? parseInt(KTUtil.getViewPort().height) -
                    parseInt(KTUtil.css(o, "marginTop")) -
                    parseInt(KTUtil.css(o, "marginBottom"))
                : parseInt(KTUtil.getViewPort().height);
            },
          }),
        (a = new KTMenu("kt_aside_menu", {
          scroll: n,
          submenu: { desktop: i, tablet: "accordion", mobile: "accordion" },
    ...
    getContentHeight: function () {
      return (
        ...
        KTUtil.getByID("kt_header") && (t -= KTUtil.actualHeight("kt_header")),
