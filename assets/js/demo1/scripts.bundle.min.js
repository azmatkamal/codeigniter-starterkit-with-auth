            ...
            top: function () {
              ...
              return (
                KTUtil.isInResponsiveRange("desktop")
                  ...
                  : KTUtil.hasClass(t, "kt-header-mobile--fixed") &&
                    (e += parseInt(
              ...
              return (
                KTUtil.isInResponsiveRange("desktop") &&
                  (KTUtil.hasClass(t, "kt-aside--minimize")
                    ? (e += 78)
                    : KTUtil.hasClass(t, "kt-aside--enabled") && (e += 255)),
                (e += parseInt(
  ...
  return {
    ...
    initHeader: function () {
      ...
      (n = KTUtil.get("kt_header")),
        (i = { offset: {}, minimize: { desktop: !1, mobile: !1 } }),
    ...
    initAsideSecondary: function () {
      KTUtil.get("kt_aside_secondary") &&
        (l = new KTToggle("kt_aside_secondary_toggler", {
          target: "body",
